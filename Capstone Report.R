...
# Check results
rmse_results %>% knitr::kable() # ok it's minimizing
...
# Check result
rmse_results %>% knitr::kable() # RMSE minimizes again !
...
# Check result
rmse_results %>% knitr::kable() # RMSE minimizes yet again!
